...
public class InputTest extends BaseTest {
    ...
    public void inputDigits() {
        ...
        String actualResult = inputField.getAttribute("text");
        if (Objects.equals(actualResult, "12345688")) {
            inputField.sendKeys(Keys.ARROW_UP);
            assertEquals(actualResult, "12345689", " We have a bug with ARROW_UP");

            inputField.sendKeys(Keys.ARROW_DOWN);
            assertEquals(actualResult, "12345688", " We have a bug with ARROW_Down.");
        }
    }
